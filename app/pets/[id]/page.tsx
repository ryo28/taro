...
import { getPet, isPetOwner } from "@/data/pet";
...
export default async function PetPage({ params }: PageProps<"/pets/[id]">) {
    ...
    const isOwner = await isPetOwner(petId);
    if (!pet) {
